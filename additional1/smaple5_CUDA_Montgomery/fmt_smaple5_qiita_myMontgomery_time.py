...
# ボトルネックだった剰余をオレオレ法にかえたver。結局はモンゴメリ乗算と同じことをしている気がする
# 計算速度比較用
# 完走に10分ほどかかる。計算のほとんどはCPU側の初期値計算に費やされており実際にGPUが可動しているのはほんの数秒
...
if __name__ == '__main__':
    for digit_level in range(3,26):
        ...
        print("GPU計算終了\t{0}\t{1}".format(digit_level,time.time()-stime))
